...
class Ui_Randomizer
    ...
    @randomize_shop.checked = false
    @randomize_shop.enabled = false
    ...
    @randomize_shop.text = Qt::Application.translate("Randomizer", "Not implemented yet", nil, Qt::Application::UnicodeUTF8)
