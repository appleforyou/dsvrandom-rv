  ...
  def self.locs
    ...
    #Somnus Reef
      {
        ...
        available: lambda { @logic.somnusWest() }
      },
      {
        zone: "Somnus Reef",
        name: "Anna",
      ...
      },
      {
        ...
        available: lambda { @logic.somnusEast() }
      },
      {
        zone: "Somnus Reef",
        name: "Serge",
    ...
    #Minera Prison Island  
      ...
      },
      {
        zone: "Minera Prison Island",
        name: "Strength Ring",
        type: ["Item", "Equipment", "Ring", "No Progression", "No Glyphs"],
        container: "Secret",
        id: "08-02-06_01",
        room: "Minera Island (Robot Plaza)",
        available: lambda { @logic.beatRobot() }
      },
      {
        zone: "Minera Prison Island",
        name: "Glyph Sleeve",
    ...
    #Giant's Dwelling
      ...
      },
      {
        ...
        available: lambda { @logic.beatGoliath() }
      },
      {
        zone: "Giant's Dwelling",
        name: "Black Drops",
