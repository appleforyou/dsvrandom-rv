...
It also has a Dominus port now, as well. This may become the primary focus going forward.
...
The original code is still in RV's DS version, so you can use it for any of the 3 games if you uncheck the "Use RV Options" checkbox. The Dominus version does not carry over much of the old functionality as of yet.
